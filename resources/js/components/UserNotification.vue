...
<!--     
    <li class="nav-item dropdown notification_dropdown">
                        <a class="nav-link  ai-icon" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                            ...
                            <span class="badge light text-white bg-primary rounded-circle" v-if="unreadCount> 0">{{unreadCount}}</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
                            <div id="dlab_W_Notification1" class="widget-media dlab-scroll p-3" style="height:380px;"  v-if="unreadCount > 0">
                                <ul class="timeline">
                                    <li>
                                        <div class="timeline-panel" v-for="item in unread" :key="item.id">
                                            <div class="media me-2">
                                                <a  @click="readNotifications(item)">
                                                <img alt="image" width="50"
                                                    src="{{ URL::asset('dashboard/images/avatar/1.jpg') }}">
                                                    </a>
                                            </div>
