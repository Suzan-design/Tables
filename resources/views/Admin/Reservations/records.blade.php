                            ...
                            <div class="accordion-item">
                                <div class="accordion-header collapsed" data-bs-toggle="collapse"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="me-3" style="margin-left:10px">
                                            <h4 class="card-title mb-2">Restaurant work times</h4>
                                            <span class="fs-12">Work times</span>
                                        </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form class="comment-form" method="post" action="{{ route('record_update') }}"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.edit-btn').on('click', function() {
                ...
                $('#dayOfWeek').val($(this).data('day')); // Assuming you have a data attribute 'data-day' on each button
