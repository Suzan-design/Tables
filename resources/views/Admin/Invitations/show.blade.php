...
@endsection
@section('title')
    Restaurants Management - Invitations
@stop
@section('content')
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-xxl-5">
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade show active" id="first">
                                        <img class="img-fluid" src="{{ URL::asset('dashboard/images/invitation.jpg') }}"
                                            alt="" />
                                    </div>
                            ...
                            <div class="col-xl-9 col-lg-6 col-md-6 col-xxl-7 col-sm-12">
                                <div class="product-detail-content">
                                    ...
                                    <div class="new-arrival-content pr">
                                        <h4>invitation : {{ $invitation->number_inv }}</h4>
                                        <div class="comment-review star-rating">
                                            <span class="review-text"> </span><a class="product-review" href=""
                                                data-bs-toggle="modal"
                                                data-bs-target="#reviewModal">{{ $invitation->expire }} /
                                                {{ $invitation->num_res }}</a>
                                        </div>
                                        <div class="d-table mb-2">
                                            <p class="price float-start d-block">discount:{{ $invitation->discount }}% -
                                                Limit:{{ $invitation->limit }} </p>
                                        </div>
                                        <p>
                                            Availability:
                                            <span class="item">
                                                {{ $invitation->is_city }} </span>
                                        </p>
                                        <p>Num.Users: <span class="item">{{ $invitation->is_follwings }}</span></p>
                                        <p>Num.Restaurants: <span class="item">{{ $invitation->is_reservations }}</span></p>
                                            ...
                                            <div class="shopping-cart mb-2 me-3">
                                                <a class="btn btn-primary" href="#"
                                                    onclick="event.preventDefault();
                                                         document.getElementById('destroy-form-{{ $invitation->id }}').submit();">
                                                    Delete
                                                </a>
                                                <form id="destroy-form-{{ $invitation->id }}"
