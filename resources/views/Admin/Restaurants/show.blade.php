...
@section('content')
    ...
    <style>
 img {
    object-fit: cover !important;  /* Prevent tiling if the image is smaller than the section */
}
</style>
                                                ...
                                                @foreach ($Restaurant->images as $image)
                                                    @if ($image->type === 'craousal')
                                                        <div class="carousel-item {{ $counter === 0 ? 'active' : '' }}">
                                                            <img style="object-fit: contain !important" class="d-block w-100" src="{{ asset($image->filename) }}"
                                                                alt="Slide {{ $counter + 1 }}">
                                                        </div>
                                                        @php $counter++; @endphp
                                                    @endif
                            ...
                            <div class="profile-details">
                                ...
                                <div class="dropdown ms-auto">
                                    <div class="mt-4">
                                        ...
                                        @endcan
                                        <a href="{{ route('Restaurant_reservations', $Restaurant->id) }}"
                                ...
                                <div class="tab-content">
                                    <div id="Restaurant" class="tab-pane fade active show">
                                        ...
                                        <div class="profile-personal-info">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-sm-3 col-5">
                                                    <h5 class="f-w-500">Restaurant taxes <span class="pull-end">:</span></h5>
                                                </div>
                                                <div class="col-sm-9 col-7"><span>{{ $Restaurant->taxes }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
