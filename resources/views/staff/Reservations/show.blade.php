            ...
            <div class="col-lg-12">
                ...
                <div class="card mt-3">
                    <div class="card-header"> Date: {{$reservation->reservation_date}} <span class="float-end">
                            <strong>Status:</strong>@if($reservation->status == 'next') Reserved @else Available @endif</span> </div>
                    <div class="card-body">
                        <div class="row mb-5">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-sm-9">
                                        <div class="brand-logo mb-3">
                                            <img class="logo-abbr me-2" width="50" src="{{ URL::asset('dashboard/images/logo.jpg') }}" alt="">
                                        </div>
