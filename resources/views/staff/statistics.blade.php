                        ...
                        <table class="table card-table display mb-4 dataTablesCard text-black" id="example5">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('restaurant_details') }}"
                                            class="btn btn-danger btn-rounded light">Details</a></td>
                                    ...
                                    {{-- <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="{{ route('restaurant_details') }}">
                                                    Details</a>
                                                <a class="dropdown-item" href="{{ route('restaurant_tables') }}">Tables
                                                    Management</a>
                                                <a class="dropdown-item" href="{{ route('restaurant_reservations') }}">
                                                    reservaions Details</a>

                                                <a class="dropdown-item" href="{{ route('my_records') }}">
                                                    Reservation_Records</a>
                                            </div>
                                        </div>
                                    </td> --}}
                                </tr>
